lets create a draft CLAUDE.md for my idea to create an mcp server that 
  uses statcan's web data service to find and research statcan data sets. 
  Lets create a discussion, potential framework, and hurdles we could 
  anticipate. We can use 
  https://www.statcan.gc.ca/en/developers/wds/user-guide downloaded 
  somewhere to use down the road when we start creating the actual server. # Development Guidelines
...
3. Best Practices
   ...
   - Test thoroughly  # Example Clients
